...
namespace AIEvent.Application.Services.Interfaces
{
    public interface IEventService
    {
        ...
        Task<Result<BasePaginated<EventsResponse>>> GetEventAsync(string? search, string? eventCategoryId, TicketType? ticketType, string? city, TimeLine? timeLine, int pageNumber = 1, int pageSize = 5);
    }
}
