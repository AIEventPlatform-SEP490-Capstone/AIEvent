...
namespace AIEvent.Application.Test.Services
{
   public class EventServiceTests
   {
       ...
       #region RequestEndEvent
        ...
        [Fact]
        public async Task UTCID21_RequestEndEventAsync_EventWithNullOrganizerProfile_ShouldReturnUnauthorized()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var ev = new Event { Id = Guid.NewGuid(), Title = "t", Description = "d", StartTime = DateTime.UtcNow.AddDays(-3), OrganizerProfileId = Guid.NewGuid(), OrganizerProfile = null!, EndTime = DateTime.UtcNow.AddDays(-1), Publish = true, Status = EventStatus.Approved };
            var request = new CompleteEventRequest
            {
                EventId = ev.Id,
                PaymentInformationId = Guid.NewGuid(),
        ...
        [Fact]
        public async Task UTCID22_RequestEndEventAsync_EventIsDeleted_ShouldReturnNotFound()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var organizerProfile = new OrganizerProfile { Id = Guid.NewGuid(), UserId = userId, OrganizationType = OrganizationType.PrivateCompany, EventFrequency = EventFrequency.Monthly, EventSize = EventSize.Medium, OrganizerType = OrganizerType.Business, EventExperienceLevel = EventExperienceLevel.Beginner, ContactName = "Name", ContactEmail = "email@ex.com", ContactPhone = "0123", Address = "addr" };
            var ev = new Event { Id = Guid.NewGuid(), Title = "t", Description = "d", StartTime = DateTime.UtcNow.AddDays(-3), OrganizerProfileId = organizerProfile.Id, OrganizerProfile = organizerProfile, EndTime = DateTime.UtcNow.AddDays(-1), Publish = true, Status = EventStatus.Approved, IsDeleted = true };
            var request = new CompleteEventRequest
            {
                EventId = ev.Id,
                PaymentInformationId = Guid.NewGuid(),
        ...
        [Fact]
        public async Task UTCID23_RequestEndEventAsync_EventNotPublished_ShouldReturnNotFound()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var organizerProfile = new OrganizerProfile { Id = Guid.NewGuid(), UserId = userId, OrganizationType = OrganizationType.PrivateCompany, EventFrequency = EventFrequency.Monthly, EventSize = EventSize.Medium, OrganizerType = OrganizerType.Business, EventExperienceLevel = EventExperienceLevel.Beginner, ContactName = "Name", ContactEmail = "email@ex.com", ContactPhone = "0123", Address = "addr" };
            var ev = new Event { Id = Guid.NewGuid(), Title = "t", Description = "d", StartTime = DateTime.UtcNow.AddDays(-3), OrganizerProfileId = organizerProfile.Id, OrganizerProfile = organizerProfile, EndTime = DateTime.UtcNow.AddDays(-1), Publish = false, Status = EventStatus.Approved };
            var request = new CompleteEventRequest
            {
                EventId = ev.Id,
                PaymentInformationId = Guid.NewGuid(),
        ...
        [Fact]
        public async Task UTCID24_RequestEndEventAsync_WithMultipleEvidenceImages_ShouldSucceed()
        {
            // Arrange
            var userId = Guid.NewGuid();
            var organizerProfile = new OrganizerProfile { Id = Guid.NewGuid(), UserId = userId, OrganizationType = OrganizationType.PrivateCompany, EventFrequency = EventFrequency.Monthly, EventSize = EventSize.Medium, OrganizerType = OrganizerType.Business, EventExperienceLevel = EventExperienceLevel.Beginner, ContactName = "Name", ContactEmail = "email@ex.com", ContactPhone = "0123", Address = "addr" };
            ...
            var request = new CompleteEventRequest
            {
                EventId = ev.Id,
                PaymentInformationId = paymentInfoId,
                EvidenceImages = new List<string> { "img1", "img2", "img3" },
                Summary = "Event summary with multiple images"
            };
            var paymentInfo = new PaymentInformation { Id = paymentInfoId, UserId = userId, IsDeleted = false, AccountHolderName = "Test", AccountNumber = "123456", BankName = "Test Bank", BankBin = "123456" };
            ...
            // Assert
            result.IsSuccess.Should().BeTrue();
            _mockUnitOfWork.Verify(x => x.EndEventRequestRepository.AddAsync(It.Is<EndEventRequest>(er => er.EvidenceImages == "img1, img2, img3" && er.Summary == "Event summary with multiple images")), Times.Once());
        }
        #endregion
