          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-2xl border-0 overflow-hidden rounded-3xl group hover:shadow-blue-200/50 transition-all duration-300">
              ...
              <CardContent className="space-y-2.5 p-6 bg-white">
                ...
                >
                  <Edit className="h-5 w-5 mr-2 text-indigo-600 group-hover:scale-110 transition-transform" />
                  <span className="text-gray-700 group-hover:text-indigo-700">Chỉnh sửa sự kiện</span>
                </Button>
                <Button 
                  variant="outline" 
                  className="w-full border-2 border-indigo-200 hover:bg-indigo-50 font-semibold transition-all duration-300 rounded-xl py-5 hover:border-indigo-400 hover:shadow-md group" 
                ...
                >
                  <Copy className="h-5 w-5 mr-2 text-indigo-600 group-hover:scale-110 transition-transform" />
                  <span className="text-gray-700 group-hover:text-indigo-700">Clone sự kiện</span>
                </Button>
