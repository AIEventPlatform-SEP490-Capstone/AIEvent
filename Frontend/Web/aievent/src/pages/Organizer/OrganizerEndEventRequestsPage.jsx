...
const OrganizerEndEventRequestsPage = () => {
  const { endEventRequests, loading, error, totalCount, getEndEventRequests } = useEndEventRequests();
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Yêu cầu kết thúc sự kiện</h1>
...
export default OrganizerEndEventRequestsPage;