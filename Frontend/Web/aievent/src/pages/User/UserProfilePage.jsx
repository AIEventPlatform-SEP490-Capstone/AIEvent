...
const UserProfilePage = () => {
  ...
  const profileData = profile ? {
    ...
    cities: (profile.interestedDistricts && Array.isArray(profile.interestedDistricts)) ? profile.interestedDistricts.map(district => district.districtName) : [],
    ...
    isTurnOnLocation: profile.isTurnOnLocation ?? profile.isLocationSharingEnabled ?? false,
