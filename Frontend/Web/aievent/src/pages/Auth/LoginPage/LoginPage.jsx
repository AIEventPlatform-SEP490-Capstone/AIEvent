          ...
          <div className="relative z-10 max-w-lg">
            ...
            <div className="space-y-6 mt-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-1">Tự động hóa thông minh</h3>
                  <p className="text-blue-100">Tối ưu hóa quy trình tổ chức sự kiện với AI</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-1">Quản lý linh hoạt</h3>
                  <p className="text-blue-100">Theo dõi và điều phối mọi khía cạnh sự kiện</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-1">Phân tích chi tiết</h3>
                  <p className="text-blue-100">Báo cáo và thống kê thời gian thực</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-md">
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link to="/terms" className="text-blue-600 hover:text-blue-700 transition-colors">Điều khoản dịch vụ</Link>
              {' '}và{' '}
              <Link to="/privacy" className="text-blue-600 hover:text-blue-700 transition-colors">Chính sách bảo mật</Link>
            </p>
          </div>
        </div>
      </div>
